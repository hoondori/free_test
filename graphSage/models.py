...
class GraphSage(nn.Module):
    ...
    def __init__(self, input_dim, hidden_dims, output_dim,
                 agg_class=MaxPoolAggregator, dropout=0.5, num_samples=25, device='cpu'):

        """

        :param input_dim: Dimension of input node features, int
        :param hidden_dims: Dimension of hidden layers, list of ints
        :param output_dim: Dimension of output node features, int
        :param agg_class: an aggregator class
        :param dropout:
        :param num_samples: # of neighbor to sample while aggregating
        """
